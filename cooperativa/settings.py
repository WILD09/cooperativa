...
# ✅ FIX Render (Persistent Disk):
# - En Render, crea un Disk con Mount Path (ej: /var/media)
# - En Render -> Environment -> agrega MEDIA_ROOT=/var/media
# - Solo se preserva lo que esté bajo el mount path del disk. [web:1090]
#
# En local, si no existe la variable, usa BASE_DIR/media como antes.
MEDIA_ROOT = config("MEDIA_ROOT", default=str(BASE_DIR / "media"))
MEDIA_ROOT = str(Path(MEDIA_ROOT))  # normaliza
