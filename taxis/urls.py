...
urlpatterns = [
    ...
    # ==========================================
    # 1B. PASSWORD: CAMBIO (logueado) + RESET
    # ==========================================

    path(
    "accounts/password_change/",
    views.PasswordChangeAuditView.as_view(),
...
# Reset: solicitar email (form) y pantalla "correo enviado"
path(
    "accounts/password_reset/",
    auth_views.PasswordResetView.as_view(
        success_url=reverse_lazy("taxis:password_reset_done"),
        # Opcional si quieres fijar templates explícitamente:
...
# Reset: confirmar nuevo password por link (AUDITADO) y pantalla "completado"
path(
    "accounts/reset/<uidb64>/<token>/",
    views.PasswordResetConfirmAuditView.as_view(
...
# Reenviar correo de reset (tu endpoint custom)
path(
    ...
    path("auditoria/pdf/", views.auditoria_pdf, name="auditoria_pdf"),
